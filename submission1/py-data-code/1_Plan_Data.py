...
for y in range(y_start, y_end+1):
    ...
    ma_path = f"data/input/CPSC/CPSC_Enrollment_{y}_01/CPSC_Contract_Info_{y}_01.csv"
    ...
    ma_path = f"data/input/CPSC/CPSC_Enrollment_{y}_01/CPSC_Enrollment_Info_{y}_01.csv"
